...
<!--sign up form-->
    ...
    <h1 class="text-center login-head">User Sign Up Form</h1>
    <form  id="std-form" action="addUser.php" method="post" name="form1" style="width:40%; margin:0 auto; color:black">
        <div class="form-group">
            <i class="fas fa-user icon"></i><label for="name" class="text-left pl-5 font-weight-bold">Name</label><small id="errorMsg1"></small><input type="text" class="form-control" placeholder="Name" name="name" id="name">
        </div>
        <div class="form-group">
            <i class="fas fa-envelope icon"></i><label for="email" class="text-left pl-5 font-weight-bold">Email</label><small id="errorMsg2"></small><input type="text" class="form-control" placeholder="Email" name="email" id="email">
            <small class="form-text">Your email is secure with us.</small>
        </div>
        <div class="form-group">
            <i class="fas fa-key icon"></i><label for="pass" class="text-left pl-5 font-weight-bold">Password</label><small id="errorMsg3"></small><input type="password" class="form-control" placeholder="Password" name="pass" id="pass">
        </div>
        <div class="login-btn-row">
            <div class="signup-text">Already have an account? Log in <a href="login.php" class="signup-link">here</a></div>
            <div>
              <span id="SuccessMsg"></span>
              <button id="Signup" type="button" class="btn btn-primary login-btn" onclick="AddUser()">Sign Up</button>
            </div>
        </div>
    </form>
